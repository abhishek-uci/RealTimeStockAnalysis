...
public class StdStats {
   ...
   /**
     ...
     */
    public static double mean(Double[] stockdata) {
        if (stockdata.length == 0) return Double.NaN;
        double sum = sum(stockdata);
   ...
   /**
     ...
     */
    public static double var(Double[] stockdata) {
        if (stockdata.length == 0) return Double.NaN;
        double avg = mean(stockdata);
        double sum = 0.0;
        for (int i = 0; i < stockdata.length; i++) {
            sum += (stockdata[i] - avg) * (stockdata[i] - avg);
        }
        return sum / (stockdata.length - 1);
    }
   ...
   /**
     ...
     */
    public static double stddev(Double[] stockdata) {
        return Math.sqrt(var(stockdata));
    }
...
*/
   ...
   /**
     ...
     */
    public static double sum(Double[] stockdata) {
        double sum = 0.0;
        for (int i = 0; i < stockdata.length; i++) {
            sum += stockdata[i];
        }
